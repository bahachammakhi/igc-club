      ...
      <div className={classes.gridcontaine}>
        <div className={classes.griditem}>
          ...
          <TrackVisibility once>
            {({ isVisible }) => isVisible &&  <CountUp end={30} duration={5}  delay={0.2}  />}
        </TrackVisibility>
        </div>
        <div className={classes.griditem}>
          <img src={Com} className={classes.imgstat} /> <div>Community</div>{" "}
          <TrackVisibility once>
            {({ isVisible }) => isVisible &&  <CountUp end={60} duration={5} delay={0.2} />}
        </TrackVisibility>
        </div>
        <div className={classes.griditem}>
          ...
          <div>Evénement</div>
          <TrackVisibility once>
            {({ isVisible }) => isVisible &&  <CountUp end={13} duration={5} delay={0.2} />}
        </TrackVisibility>
        </div>
        <div className={classes.griditem}>
          <img src={Web} className={classes.imgstat} /> <div>Site web</div>{" "}
          <TrackVisibility once>
            {({ isVisible }) => isVisible &&  <CountUp end={3} duration={5}  delay={0.2}/>}
        </TrackVisibility>
        </div>
      </div>
